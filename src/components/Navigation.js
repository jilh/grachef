                            ...
                            <Container>
                                ...
                                {/* <Navbar.Collapse id="basic-navbar-nav"> */}
                                    <Nav className="ml-auto nav-hack">
                                        ...
                                        <Nav.Link as={Link} to="/cart"><FaShoppingCart className={navbarChanged ? "navigation-link-customized" : "navigation-link"} /><sup><Badge pill className={'pill-style'}>{value.getCartItemQuantity()}</Badge></sup></Nav.Link>
                                    </Nav>
                                {/* </Navbar.Collapse> */}
                            </Container>
